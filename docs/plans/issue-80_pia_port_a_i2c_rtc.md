...
- DS3231 モジュールには、個体によって **24C32 EEPROM**、**プルアップ抵抗**、**充電回路** が載る場合がある。
...
- DS3231 モジュールの回路図または商品写真で、24C32 やプルアップの有無を確認する。
...
- 24C32 EEPROM、SSD1306 OLED、その他 I2C デバイスのドライバ。
